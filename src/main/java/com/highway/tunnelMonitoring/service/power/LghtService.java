...
public class LghtService implements CrudService<Lght> {
    ...
    @Override
    public Result<Lght> findAll(String linkId, int page, int size, String sort_column, String sort_direction) {
        int offset = (page - 1) * size;
        List<Lght> list = lghtMapper.lghtFindAll(linkId, offset, size);
