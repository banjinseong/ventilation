package com.highway.tunnelMonitoring.dto.power.swtbrd;
...
@AllArgsConstructor
@NoArgsConstructor
public class SwtbrdMonitorDTO {
    private String swtbrd_no; // 배전반 번호
    private String pow_pop_no; //수배전반 번호
    private String change_dt; //변경일시
    private int crcbrk_sttus;//차단기 상태
    private char elclkg_alarm_at;// 누전 경보 여부
